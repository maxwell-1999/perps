...
export const interfaceFeeBps: {
  ...
  [arbitrumGoerli.id]: {
    feeAmount: {
      [PositionSide2.short]: Big6Math.fromFloatString('0.001'), // 1bps
      [PositionSide2.long]: Big6Math.fromFloatString('0.001'), // 1bps
  ...
  [arbitrum.id]: {
    feeAmount: {
      [PositionSide2.short]: Big6Math.fromFloatString('0.001'), // 1bps
      [PositionSide2.long]: Big6Math.fromFloatString('0.001'),
      [PositionSide2.maker]: 0n,
      [PositionSide2.none]: 0n,
    },
