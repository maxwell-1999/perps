  ...
  return (
    <div className="relative">
      ...
      <svg width={22} height={22} fill="none" {...props}>
        ...
        <rect y={5} width={22} height={17} rx={2} stroke="currentColor" strokeWidth={5} mask="url(#prefix__a)" />
        <mask id="prefix__b" fill="#fff">
          <rect x={6} width={11} height={7} rx={2} />
        </mask>
        <rect x={6} width={11} height={7} rx={2} stroke="currentColor" strokeWidth={5} mask="url(#prefix__b)" />
      </svg>
    </div>
  )
}
...
function HamburgerSVG(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width={22} height={16} fill="none" {...props} role="button">
      <path d="M2 2h17.82M2 8h17.82M2 14h17.82" stroke="#808191" strokeWidth={2.5} strokeLinecap="round" />
    </svg>
  )
}

const MemoHamburgerSVG = React.memo(HamburgerSVG)
export { MemoHamburgerSVG }
