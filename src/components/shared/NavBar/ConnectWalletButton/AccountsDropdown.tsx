            ...
            {(() => {
              if (!connected) {
                return (
                  ...
                  >
                    ...
                    {/* <ArrowDropDownRounded className={`dropdown-arrow transition-all duration-300 w-6 h-6 ease-out `} /> */}
                  </div>
                )
              }
              ...
              return (
                <div style={{ display: 'flex', gap: 3 }}>
                  ...
                  >
                    <div className="flex items-center capitalize dropdown-value f15 weight-400">
                      {chain && chain.name && (
                        <img
                    ...
                    <DDArrow className={` transition-all duration-300 ml-2 ease-out mr-2`} />
                  </div>
                  {/* Accound DD */}
                  <button type="button" ref={ref} {...anchorProps}>
                    ...
                    >
                      <WalletIcon className="ml-1 mr-2 text-blue" />
                      <TokenAccountBalance />
                      ...
                      >
                        ...
                        <DDArrow className={` transition-all duration-300 ml-1 ease-out `} />
                      </div>
                    </div>{' '}
                  </button>
                  <ControlledMenu
                          ...
                          <div className="flex items-center gap-x-3 text-[#C3C2D4]">
                            <IconBG
                              onClick={(e) => {
                                ...
                                // setSnack({
                                //   message: 'Account coppied to clipboard Successfully!',
                                //   severity: 'success',
                                // })
                              }}
                            >
                            ...
                            <IconBG
                              onClick={(e) => {
                                e.preventDefault()
                                e.stopPropagation()
                                window.open(`${blockExplorer}/address/${account.address}`, '_blank')
                              }}
                            >
                              <ShareIcon />
                            </IconBG>
          ...
          >
            {(() => {
              if (!connected) {
                return (
                  <>
                    <BlueBtn onClick={openConnectModal} className={'px-5 py-[5px] !h-fit ' + className}>
                      Connect Wallet
                    </BlueBtn>
                  </>
                )
              ...
              if (chain.unsupported) {
                return (
                  <BlueBtn onClick={openChainModal} className={'px-5 py-[5px] !h-fit ' + className}>
                    {/* <Wallet className="" /> */}
                    Switch Network
                  </BlueBtn>
                )
...
const IconBG = ({ children, onClick }: { children: JSX.Element; onClick: any }) => (
  <div
